...
En este proyecto **se trabajó con una DATA para la creacion de una _página web_ donde la intencion es mostrar informacion acerca de los pokemones.** que se adecúe a lo que el usuario  [**maestro pokemon**](https://pokemon.fandom.com/es/wiki/Maestro_Pok%C3%A9mon?so=search)
necesita.
